...
$.each(materialList, function(key, value) {
    window['selMaterialColor'] = value.colorName; //used for mailDesign.js - send the chosen color name to manufacturer - default is last color loaded
